...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Maaf Remix Media Tidak Valid```"
PP_CHANGED = "```Remix, Foto Profil Anda Telah Berhasil Diubah```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Remix, Mohon Gunakan Yang Lebih Besar```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah```"

BIO_SUCCESS = "```Remix, Bio Anda Telah Berhasil Diubah```"

NAME_OK = "```Remix, Nama Anda Telah Berhasil Diubah```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah```"
USERNAME_TAKEN = "```Mohon Maaf Remix, Username Itu Sudah Ada Yang Menggunakannya```"
# ===============================================================
