...
async def gcast(event):
    ...
    if not kinguser:
        return await event.edit("`Remix, Mohon Berikan Sebuah Pesan`")
    tt = event.text
    msg = tt[6:]
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Perintah :** `.gcast` <Text>\
        \n  •  **Function : **Global Group Broadcast , Mengirim Pesan Global Broadcast pesan ke Seluruh Grup Yang Remix Masuki\
        \n\n  •  **Perintah :** `.pcast` <Text>\
