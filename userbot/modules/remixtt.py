...
async def _(event):
    ...
    if ".com" not in d_link:
        await event.edit("`Mohon Maaf Remix, Saya Membutuhkan Link Video Tiktok Untuk Download Video Tiktok` **(._.)**")
    else:
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            await event.edit("**Error :** `Remix Mohon Buka Blokir` @ttsavebot `Dan Coba Lagi!`")
            return
